// lib/ui/seller/seller_homepage/seller_homepage_screen.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:mycrochetbag/ui/seller/seller_homepage/view_model/seller_homepage_view_model.dart';
...
class SellerHomepageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => SellerHomepageViewModel(),
      child: SafeArea(
        child: Consumer<SellerHomepageViewModel>(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Hello, ${viewModel.currentSellerDisplayName ?? 'Seller'}',
                      ...
                      Expanded(
                        child:
                            viewModel.isLoading
                                ...
                                : viewModel.filteredSellerBags.isEmpty
                                ? const Center(
                                  child: Text(
                                ...
                                : GridView.builder(
                                  ...
                                  itemCount:
                                      viewModel.filteredSellerBags.length,
                                  itemBuilder: (context, index) {
                                    final bag =
                                        viewModel.filteredSellerBags[index];
  ...
  void _showSortOptions(
    ...
    SellerHomepageViewModel viewModel,
  ) {
  ...
  void _showFilterOptions(
    ...
    if (viewModel.allSellerBags.isNotEmpty) {
      // <-- 使用公共 getter `allSellerBags`
      minPrice = viewModel.allSellerBags
          .map((e) => e.price)
          .reduce((a, b) => a < b ? a : b);
      maxPrice = viewModel.allSellerBags
          .map((e) => e.price)
          .reduce((a, b) => a > b ? a : b);
